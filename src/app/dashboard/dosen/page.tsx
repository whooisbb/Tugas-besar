      ...
      <main className="flex-1 p-5 md:ml-72 md:p-10">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-[28px] border border-white/10 bg-gradient-to-br from-purple-500 to-pink-500 p-7 shadow-2xl">
            ...
            <p className="mt-2 text-white/80">
              ...
              Jadwal Pengganti Yang Tersedia
        ...
        <div className="mt-10 space-y-6">
          ...
          {pengumuman.map((item) => (
            ...
            <div
              key={item.id}
              className="rounded-[32px] border border-white/10 bg-white/5 p-7 shadow-2xl backdrop-blur-xl transition hover:border-blue-500/40"
            >
